...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChecklistPhase.order'
        db.add_column(u'core_checklistphase', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChecklistPhase.order'
        db.delete_column(u'core_checklistphase', 'order')
